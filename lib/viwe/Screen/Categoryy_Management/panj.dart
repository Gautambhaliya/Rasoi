...
class Panj extends StatefulWidget {
  String category = 'Panjabi';
  String admincategory = 'Panjabi';

  Panj({super.key});

  @override
  State<Panj> createState() => _PanjState();
}

class _PanjState extends State<Panj> {
