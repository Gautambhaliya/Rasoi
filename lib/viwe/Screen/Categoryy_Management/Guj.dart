...
class Gujrati extends StatefulWidget {
  String category = 'Gujarati';
  String admincategory = 'Gujarati';

  Gujrati({super.key});

  @override
  State<Gujrati> createState() => _GujratiState();
}

class _GujratiState extends State<Gujrati> {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          color: Colors.white,
          boxShadow: [
            BoxShadow(color: const Color.fromARGB(31, 8, 8, 8), blurRadius: 10)
          ],
        ),
        child: Column(
